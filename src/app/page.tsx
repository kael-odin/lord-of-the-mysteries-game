...
const FEATURES = [
  ...
  },
  {
    icon: Scroll,
    title: "六卷 · 二十六章冒险",
    desc: "从水仙花街的死而复生开始，加入值夜者，调查安提哥努斯笔记——直面粉红舞会、大雾霾、灰雾之上·塔罗会，再随海渊、北陆、南港、旧都、骨冢、镜心一路沉入灰雾深处的归墟、归名，回到廷根忆归、停在贝克兰德的此刻，从岔口走出自己的、同路的、各自的、自定的路，再往空白上认出没被叫出名字的脸、被忘了名字的名字、被藏起来的人、被藏起来的心。六卷母题：守护→偷→归→此刻→行→认。",
  },
];
      ...
      <section className="relative flex min-h-screen flex-col overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-1 flex-col items-center justify-center px-6 text-center">
          ...
          <p className="mt-6 text-[10px] tracking-[0.2em] text-white/30" style={{ animation: "fadeUp 1s ease both", animationDelay: "0.6s" }}>
            本地存档 · 六卷二十六章 · {ALL_ENDING_IDS.length} 种结局 · 六条途径攀升至序列8
          </p>
        </div>
