...
export const ITEMS: Record<string, Item> = {
  ...
  // 第十七章·忆归——廷根三段忆的剧情信物（无战斗被动，仅行囊留存与回血加成）
  half_sleeve: { id: "half_sleeve", name: "灰毛线半截袖子", desc: "廷根水仙花街旧房东罗老太太替你织了又拆、拆了又织的、灰毛线的、半截袖子。她记了你死那夜——每年，都替你，织半截袖子，又拆，又织。攥在掌心，温着，像有人替你，温了好几个冬。剧情中可稳住心神（每夜休整额外回复理智+2）。", price: 4 },
  oldneil_note: { id: "oldneil_note", name: "老尼尔垫的扮演法笔记", desc: "黑荆棘公司旧值班日志最后一页，老尼尔那手抖抖的、歪歪的字：「……给后生垫一笔。他，还嫩。等他，稳了，再，告诉他。」他替你续过一笔「扮演法」的笔记，没告诉队长，也没告诉你——他怕你刚复生扛不住，先替你垫了一笔。老尼尔没等到你稳，可他那笔垫，一直在。", price: 5 },
};
