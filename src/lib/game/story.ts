...
export const ENDINGS: Record<string, { title: string; tone: "gold" | "red" | "gray" | "green" | "purple"; hint?: string }> = {
  ...
  namewaiter: { title: "等名者", tone: "gold", hint: "你在塔罗会之外被派的差事之外走完定完的路之外认出没被叫出名字的东西之外认名被忘了名字的之外认人被藏起来的人之外认心被藏起来的心之外留下一笔你的之外留下一个名字之外留下一段路之外留下一颗心之外等下一程之外自己往灰雾里等一个名字把它等名下来。二十五枚铜币并排在扶手上——塔罗会的椅子，替你，记你等下来的那个名字。第八卷，承。" },
};
