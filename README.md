...
<p align="center">
  <img src="public/readme/chapters.svg" alt="八章剧情脉络图" width="900">
</p>

从廷根的苏醒到雾都的远赴——前五章完整闭环于「绯红假面舞会」，第六章开启第二卷「贝克兰德的雾」，第七章「大雾霾」收束三日大雾的源头，第八章「灰雾之上·塔罗会」让你坐进第二十三张椅子，成为塔罗会一员。

## 玩法

- **八大章节**：苏醒 → 值夜者 → 安提哥努斯之影 → 钟楼失踪案 → 绯红假面舞会 → 贝克兰德的雾 → 大雾霾 → 灰雾之上·塔罗会
...
- **14 种结局**：从「灰雾之邀」到「篡夺者」「殉锚」「廷根之狼」「廷根的守夜人」「破雾者」「第二十三张椅子」……
- **11 条支线**：值夜同僚、水仙花街窃影、铁十字街连环失踪、雾纹信使、灰河守墓人、钟楼秘偶、雾中拾遗、济贫院仍走人、借雾倒货、值夜者贝克兰德借调、心理炼金会内务
...
src/
  ...
  lib/game/
    ...
    data.ts                 途径 / 物品 / 敌人
    story.ts                章节标题与结局注册
    story1.ts ~ story7.ts   第一~八章（349 节点）
    art.ts                  原创 SVG 场景背景
