...
- **22 种结局**：从「灰雾之邀」到「篡夺者」「殉锚」「廷根之狼」「廷根的守夜人」「破雾者」「第二十三张椅子」「破潮者」「守名者」「守向者」「守根者」「守人者」「守真者」「守归者」「守归名者」……
- **19 条支线**：值夜同僚、水仙花街窃影、铁十字街连环失踪、雾纹信使、灰河守墓人、钟楼秘偶、雾中拾遗、济贫院仍走人、借雾倒货、值夜者贝克兰德借调、心理炼金会内务、海上之城旧灯塔、霜砚镇旧磨坊、南港旧领航塔、旧都残卷阁废档塔、骨冢残碑阁废碑塔、镜心残映阁废映塔、归墟残归阁废归塔、归名残名阁废名塔
...
src/
  ...
  lib/game/
    ...
    data.ts                 途径 / 物品 / 敌人
    story.ts                章节标题与结局注册
    story1.ts ~ story15.ts   第一~十六章（560 节点）
    art.ts                  原创 SVG 场景背景
